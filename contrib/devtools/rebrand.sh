...
git grep -z -l 2016\ The\ Freicoin | xargs -0 sed -i 's:2016 The Freicoin:2016 The Bitcoin:g'
git grep -z -l 2017\ The\ Freicoin | xargs -0 sed -i 's:2017 The Freicoin:2017 The Bitcoin:g'
...
git grep -z -l 2016\ Freicoin | xargs -0 sed -i 's:2016 Freicoin:2016 Bitcoin:g'
git grep -z -l 2017\ Freicoin | xargs -0 sed -i 's:2017 Freicoin:2017 Bitcoin:g'
git grep -z -l 2012\,\ Freicoin | xargs -0 sed -i 's:2012, Freicoin:2012, Bitcoin:g'
...
git grep -z -l freico.in/depends-sources | xargs -0 sed -i 's:freico.in/depends-sources:bitcoincore.org/depends-sources:g'
git grep -z -l travis-ci.in.freico | xargs -0 sed -i 's:travis-ci.in.freico:travis-ci.org/freicoin:g'
